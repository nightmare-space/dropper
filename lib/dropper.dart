                              ...
                              TextButton(
                                onPressed: () async {
                                  await Clipboard.setData(
                                    ClipboardData(
                                      text:
                                          '${image.getRed(curColor)} | ${image.getGreen(curColor)} | ${image.getBlue(curColor)}',
                                    ),
                                  );
                                  showToast('RGB已复制');
                                },
                              ...
                              TextButton(
                                onPressed: () async {
                                  await Clipboard.setData(
                                    ClipboardData(
                                      text:
                                          '0x${chooseColor.value.toRadixString(16).toUpperCase()}',
                                    ),
                                  );
                                  showToast('HEX已复制');
                                },
                                child: SizedBox(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Text(
                                        'HEX : 0x${chooseColor.value.toRadixString(16).toUpperCase()} ',
                                        style: const TextStyle(
                                          color: Color(0xff212121),
                                          fontWeight: FontWeight.bold,
                                        ),
